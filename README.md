...
- **Kanji Explorer & Dictionary**: Search over 3,000 kanji characters across grades by English keyword, Romaji, or Japanese readings.
...
- **Full Library Search**: Search through the 3,000 kanji database (all Joyo & Jinmeiyo characters) by English keyword, Romaji pronunciation, Japanese reading, or character glyph.
