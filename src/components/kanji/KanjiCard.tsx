      ...
      <div className={`card-flip-inner ${isFlipped ? "is-flipped" : ""}`}>
        ...
        <div className="card-face card-front">
          ...
          <div className="pt-2 border-top border-secondary border-opacity-25 d-flex justify-content-between align-items-center">
            <span className="small text-white fw-bold d-flex align-items-center gap-1">
            ...
            <button
              ...
              className="btn btn-sm text-white fw-semibold d-flex align-items-center gap-1 p-0 hover-text-white"
        ...
        <div className="card-face card-back text-start">
          ...
          <div className="d-flex justify-content-between align-items-center w-100 mb-2">
            ...
            <span className="small text-white fw-medium d-flex align-items-center gap-1">
          ...
          {/* Meaning */}
          <div className="mb-3">
            <h3 className="fw-bold text-white mb-1" style={{ fontSize: "1.45rem", color: "#ffffff" }}>
              {kanji.kanji.meaning.english}
            </h3>
            {kanji.mnemonic && (
              <p className="small text-white fst-italic mb-0" style={{ opacity: 0.95 }}>
                "{kanji.mnemonic}"
              </p>
            )}
          </div>
          ...
          {/* Readings */}
          <div className="p-2 rounded mb-3 bg-dark bg-opacity-75 border border-secondary border-opacity-25">
            <div className="d-flex justify-content-between align-items-center mb-2">
              <div>
                <span className="badge-tag vermilion me-2">訓 Kun'yomi</span>
                <span className="text-white fw-bold fs-6">{kanji.kunyomi_ja}</span>
              </div>
            ...
            <div className="d-flex justify-content-between align-items-center">
              <div>
                ...
                <span className="text-white fw-bold fs-6">{kanji.onyomi_ja}</span>
              </div>
          ...
          <div className="flex-grow-1 overflow-auto pe-1" style={{ maxHeight: "150px" }}>
            <h6 className="small text-uppercase fw-bold text-white mb-2">Examples:</h6>
            {kanji.examples.slice(0, 3).map((ex, idx) => (
              <div
                ...
                <div>
                  <div className="text-white small fw-bold">{ex.japanese}</div>
                  <div className="text-white fw-medium" style={{ fontSize: "0.82rem", opacity: 0.95 }}>
                    {ex.meaning.english}
                  </div>
                </div>
                <AudioButton
